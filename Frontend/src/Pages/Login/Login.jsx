    ...
    '>
        ...
        <form action="" onSubmit={handleSubmit}>
            <div>
                ...
                <input className='w-full input input-bordered h-10' placeholder='username' type="text"
                value={username}
            ...
            <div>
                ...
                <input className='w-full input input-bordered h-10' placeholder='password' type="password"
